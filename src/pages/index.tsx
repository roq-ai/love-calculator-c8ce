  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Love Calculator App: Discover the Power of Love! Enter your names, hit Calculate Love, and let the magic happen. Share your love percentage with the world, then try again. Engaging, visually appealing, and fun - a new way to measure compatibility!"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1687360441296-fddbccf0acb3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MXwxfHNlYXJjaHwxfHxsb3ZlfGVufDB8fHx8MTY5NTIyNzY1MHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@hikiapp?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Hiki App`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Love Calculator App: Discover the Power of Love! Enter your names, hit Calculate Love, and let the magic happen. Share your love percentage with the world, then try again. Engaging, visually appealing, and fun - a new way to measure compatibility!`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Guest User" type="guest-user" abilities={appConfig.ownerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
