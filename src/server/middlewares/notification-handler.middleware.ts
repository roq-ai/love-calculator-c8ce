...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Order #12345.create': { roles: ['tenant-roles', 'tenant-owner-roles'], key: 'order', tenantPath: [], userPath: [] },
  'Order #12345.update': { roles: ['tenant-roles'], key: 'order', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['guest-user'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['guest-user'];
